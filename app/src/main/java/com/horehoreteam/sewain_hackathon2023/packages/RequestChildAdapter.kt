...
class RequestChildAdapter (
    private val items:List<ItemRequestPacket>
): RecyclerView.Adapter<RequestChildAdapter.RequestChildViewHolder>() {
        ...
        holder.apply {
            binding.apply {
                ...
                if (currItem.submittedCaterings.isNotEmpty()){
                    ...
                    rvSubmittedCaterings.adapter = RequestChildChildAdapter(currItem.submittedCaterings)
                ...
                if (currItem.submittedWardrobes.isNotEmpty()){
                    ...
                    rvSubmittedWardrobe.adapter = RequestChildChildAdapter(currItem.submittedWardrobes)
                ...
                if (currItem.submittedDecoration.isNotEmpty()){
                    ...
                    rvSubmittedDecoration.adapter = RequestChildChildAdapter(currItem.submittedDecoration)
                    rvSubmittedDecoration.layoutManager = LinearLayoutManager(itemView.context)
                }else {

                    rvSubmittedDecoration.isVisible = true
                }
